...
// Fetch all chairs from the database
$sql = "SELECT * FROM products WHERE category_id = 2"; // category_id 2 is for chairs
...
<div class="container mx-auto py-4">
    <section class="bg-white py-8 px-6 md:px-12 rounded-lg shadow-lg">
        <h2 class="text-4xl font-bold text-center mb-12">Chairs</h2>
