...
$sql = "SELECT * FROM products WHERE category_id = 3"; // category_id 3 is for tables
...
<div class="container mx-auto py-4">
    <section class="bg-white py-8 px-6 md:px-12 rounded-lg shadow-lg">
        <h2 class="text-4xl font-bold text-center mb-12">Tables</h2>
