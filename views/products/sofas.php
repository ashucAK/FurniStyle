...
$sql = "SELECT * FROM products WHERE category_id = 1"; // category_id 1 is for sofas
...
<div class="container mx-auto py-4">
    <section class="bg-white py-8 px-6 md:px-12 rounded-lg shadow-lg">
        <h2 class="text-4xl font-bold text-center mb-12">Sofas</h2>
